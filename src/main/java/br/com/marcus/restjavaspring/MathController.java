...
import br.com.marcus.restjavaspring.service.NumberConverter;
import br.com.marcus.restjavaspring.service.SimpleMath;
...
public class MathController {
    ...
    public Double sum(
        ...
        if (!NumberConverter.isNumeric(numberOne) || !NumberConverter.isNumeric(numberTwo)) {
            throw new NaoSuportaContaException("Please set a numeric value!");
        }
        return math.sum(
